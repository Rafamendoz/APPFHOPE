...
class ColorController extends Controller
{
    ...
    public function getColors(){
        try {
            ...
            $colors = DB::select('CALL Obtener_colors_vista(?)',array("ACTIVO"));
    ...
    public function getColorsRest(Request $request){
        try {
            log::info("REQUEST: ".$request);
            $colors = Color::all();
            if(sizeof($colors)<1){
    ...
    public function getColorRestById(Request $request,$id){
        try {
            log::info('REQUEST '.$request);
            $color = Color::find($id);
            if(is_null($color)){
    ...
    public function putColor(Request $request, $id){
        try {
            Log::info("REQUEST: ".$request);
            $color = Color::find($id);
            if(is_null($color)){
